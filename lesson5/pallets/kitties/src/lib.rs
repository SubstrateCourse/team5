...
use frame_support::{decl_module, decl_storage, decl_error, ensure, StorageValue, StorageMap, traits::Randomness, decl_event};
...
impl<T: Trait> Module<T> {
	...
	fn insert_kitty(owner: T::AccountId, kitty_id: u32, kitty: Kitty) {
		...
		OwnedKittiesCount::<T>::insert(&owner, user_kitty_id + 1);
