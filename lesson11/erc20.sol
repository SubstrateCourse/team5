...
contract ERC20 {
    ...
    function _transfer(
        ...
        require(to != address(this), "ERC20: transfer to contract address");
    ...
    function transferFrom(
        ...
        require(
            _allowance[owner][msg.sender] >= value,
            "ERC20: not allowed to transferfrom"
        );

        _allowance[owner][msg.sender] = _allowance[owner][msg.sender].sub(
            value
        );
